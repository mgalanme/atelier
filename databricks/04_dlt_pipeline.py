...
@dlt.table(
    name="trend_signals_bronze",
    comment="Raw trend signals (from existing bronze table)"
)
...
@dlt.table(
    name="social_listening_bronze",
    comment="Social listening signals (from existing bronze table)"
)
...
@dlt.table(
    name="trend_signals_silver",
    comment="Validated trend signals"
)
...
@dlt.table(
    name="trends_gold",
    comment="Aggregated trend strength by season, colour and silhouette"
)
def trends_gold():
    return (
